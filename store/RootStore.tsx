...
export const RootStore = types.model('RootStore', {
    ...
    handleInputChange(field: "todo" | "completed" | "editTodoId", value: string | boolean | number | null): void {
        (self.curInputTodo as any)[field] = value;
    },
    setCurrInputTodo(title: string, completed: boolean, editTodoId: number | null): void {
    ...
    .actions(self => ({
        ...
        updateTodos: flow(function* (id: number | null, title: string, completed: boolean) {
            try {
                const updatedTodo = {
                    todo: title,
                    completed: completed
